...
if __name__ == '__main__':
    VOC2Yolo(
        ...
        voc_img_path=r'E:\DATASET\COCO_hat\val2017', # 数据集图片文件夹存储路径
        voc_xml_path=r'E:\DATASET\COCO_hat\xml\val2017', # 标签xml文件夹存储路径
        yolo_txt_save_path=r'E:\DATASET\COCO_hat\voc2yolo\val2017' # 将要生成的txt文件夹存储路径
    )